            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div>
                        ...
                        <a class="btn btn-outline-secondary mb-3" href="https://www.reddit.com/r/acturnips/submit?text=Link+to+the+queue:+{{ urlencode(route('queue.join', compact('turnipQueue'))) }}&url={{ urlencode(route('queue.join', compact('turnipQueue'))) }}" target="_blank" rel="noopener">
